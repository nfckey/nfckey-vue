    ...
    <div class="flex flex-col items-center gap-24">
      <div class="privacy">
        ...
        <p>
          ...
          обеспечению безопасности персональных данных, предпринимаемые «NFCKEY» (далее — Оператор).
        </p>
        <ol>
          <li>
          ...
          <li>
            ...
            веб-сайта <a href="https://nfckey.tech/">https://nfckey.tech/</a>.
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            ...
            <a href="https://nfckey.tech/">https://nfckey.tech/</a>.
          </li>
          <li>
        ...
        <ol>
          ...
          <li>
            ...
            <a href="mailto:help@nfckey.tech?subject=«Актуализация персональных данных»">
              help@nfckey.tech
            </a>
          ...
          <li>
            ...
            <a
              href="mailto:help@nfckey.tech:?subject=«Отзыв согласия на обработку персональных данных»"
            >
              help@nfckey.tech
            </a>
        ...
        <ol>
          <li>
            ...
            <a href="mailto:help@nfckey.tech">help@nfckey.tech</a>.
          </li>
          <li>
          ...
          <li>
            ...
            адресу <a href="https://nfckey.tech/privacy">https://nfckey.tech/privacy</a>.
          </li>
        </ol>
      </div>
    </div>
